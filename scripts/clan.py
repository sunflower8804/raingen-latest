        ...
        if game.clan.clan_settings['all accessories']:
            for c in Cat.all_cats_list:
                ...
                acc_list = acc_list + Pelt.wild_accessories + Pelt.plant_accessories + Pelt.collars + Pelt.lizards + Pelt.herbs2 + \
                            ...
                            Pelt.haloaccs + Pelt.ponchoaccs + Pelt.glassesaccs + Pelt.vulturemasks + Pelt.iteratormasks + \
                            Pelt.basecollars + Pelt.pearlcollars + Pelt.studdedcollars + Pelt.newaccs4 + Pelt.newaccs5
