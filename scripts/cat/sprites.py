...
class Sprites:
    ...
    def load_all(self):
        ...
        fancyskin_colors = [
            ...
            ['WHITECLAWS', 'PINKCLAWS', 'BLUECLAWS', 'GREENCLAWS', 'YELLOWCLAWS', 'REDCLAWS', 'GREYCLAWS', 'FANGS'],
            ['BLACKSTINGER', 'GREYSTINGER', 'WHITESTINGER', 'GOLDSTINGER', 'PURPLEDROPWIG', 'GREENDROPWIG', 'BLUEDROPWIG', 'WHITEDROPWIG']
        ]
