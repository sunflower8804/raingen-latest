...
class Pelt:
    ...
    ramhorns = with_suffix(['WHITE', 'BLACK', 'RED', 'YELLOW', 'GREEN', 'BLUE', 'ORANGE', 'BROWN'], 'HORNSRAM')
    scavhorns = with_suffix(['WHITE', 'BLACK', 'RED', 'YELLOW', 'GREEN', 'BLUE', 'ORANGE', 'BROWN'], 'HORNSSCAV')
    elitehorns = with_suffix(['WHITE', 'BLACK', 'RED', 'YELLOW', 'GREEN', 'BLUE', 'ORANGE', 'BROWN'], 'HORNSELITE')
    unihorns = with_suffix(['WHITE', 'BLACK', 'RED', 'YELLOW', 'GREEN', 'BLUE', 'ORANGE', 'BROWN'], 'HORNSLANCER')
    antlers = ['ANTLERS']
    dragonhorns = with_suffix(['WHITE', 'BLACK', 'RED', 'YELLOW', 'GREEN', 'BLUE', 'ORANGE', 'BROWN'], 'HORNSDRAGON')
    tailfrills = with_suffix(['BLUE', 'ORANGE', 'GREEN', 'PURPLE', 'PINK', 'RED', 'YELLOW', 'CYAN'], 'TAILFRILLS')
    spikes = with_suffix(['YELLOW', 'GREEN', 'AQUA', 'CYAN', 'BLUE', 'PURPLE', 'PINK', 'RED', 'ORANGE'], 'SPIKES')
    seaslugpapillae = ['SEASLUGPAPILLAE']
    thorns = with_suffix(['BLACK', 'WHITE'], 'THORNS')
    gills = with_suffix(['PINK', 'BLUE', 'RED', 'LIME', 'YELLOW', 'WHITE', 'RAINBOW', 'GRAY', 'HOT', 'COLD'], 'GILLS')
    tongues = with_suffix(['FUCHSIA', 'PASTEL', 'KOBI', 'RED', 'GREY', 'ORANGE'], 'TONGUE')
    moth = with_suffix(['WHITE', 'BLACK', 'RED', 'YELLOW', 'GREEN', 'BLUE', 'ORANGE', 'BROWN'], 'MOTH')
    glowspots = with_suffix(['WHITE', 'RED', 'PINK', 'ORANGE', 'YELLOW', 'BLUE', 'GREEN'], 'GLOWSPOTS')
    lizardneedles = with_suffix(['BLACK', 'WHITE', 'RAINBOW'], 'NEEDLES')
    catfishwhiskers = with_suffix(['WHITE', 'PINK', 'RED', 'YELLOW', 'GREEN', 'REDYELLOW', 'BLUE', 'PURPLE', 'BLACK', 'BLUEGREEN', 'BLUEPINK', 'BROWN'], 'CATFISHWHISKERS')
    dragonwhiskers = with_suffix(['WHITE', 'PINK', 'RED', 'YELLOW', 'GREEN', 'REDYELLOW', 'BLUE', 'PURPLE', 'BLACK', 'BLUEGREEN', 'BLUEPINK', 'BROWN'], 'DRAGONWHISKERS')
    lizardfins = with_suffix(['PINK', 'BLUE', 'RED', 'GREEN', 'YELLOW', 'WHITE'], 'FINS')
    anglerfish = ['ANGLERFISH']
    quills = with_suffix(['WHITE', 'BLACK'], 'QUILLS')
    centipedegrowths = ['CENTIPEDEGROWTHS']
    tears = ['TEARS']
    spearholes = with_suffix(['WHITE', 'BLACK', 'MIX', 'RAINBOW'], 'SPOTS')
    cyanfeatures = with_suffix(['WHITE', 'ORANGE', 'BROWN', 'PINK', 'PINKER', 'TEAL', 'GREEN', 'BLOODY', 'LAVENDER', 'PURPLE', 'CYAN', 'BLUE', 'DARKBLUE', 'DARKPURPLE', 'BLACK', 'EGG', 'YELLOW'], 'CYAN')
    cyanwings = ['CYANWINGS']
    ...
    conurewings = with_suffix(['WHITE', 'SKY', 'BLUE', 'INDIGO', 'PURPLE', 'GHOST', 'BLACK', 'CREAM', 'YELLOW', 'ORANGE', 'SCARLET', 'RED', 'PINK', 'MINT', 'LIME', 'GREEN', 'MAROON', 'PERIWINKLE', 'LAVENDER'], 'CONUREWINGS')
    lovebirdwings = with_suffix(['WHITE', 'SKY', 'BLUE', 'INDIGO', 'PURPLE', 'GHOST', 'BLACK', 'CREAM', 'YELLOW', 'ORANGE', 'SCARLET', 'RED', 'PINK', 'MINT', 'LIME', 'GREEN', 'MAROON', 'PERIWINKLE', 'LAVENDER'], 'LOVEBIRDWINGS')
    pidgeonwings = with_suffix(['WHITE', 'SKY', 'BLUE', 'INDIGO', 'PURPLE', 'GHOST', 'BLACK', 'CREAM', 'YELLOW', 'ORANGE', 'SCARLET', 'RED', 'PINK', 'MINT', 'LIME', 'GREEN', 'MAROON', 'PERIWINKLE', 'LAVENDER'], 'PIDGEONWINGS')
    vulturewings = with_suffix(['WHITE', 'SKY', 'BLUE', 'INDIGO', 'PURPLE', 'GHOST', 'BLACK', 'CREAM', 'YELLOW', 'ORANGE', 'SCARLET', 'RED', 'PINK', 'MINT', 'LIME', 'GREEN', 'MAROON', 'PERIWINKLE', 'LAVENDER'], 'VULTUREWINGS')
