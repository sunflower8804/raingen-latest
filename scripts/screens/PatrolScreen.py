...
class PatrolScreen(Screens):
            ...
            if len(self.current_patrol) < 6:
                if not game.clan.clan_settings["random med cat"]:
                    able_no_med = [
                        ...
                        if cat.status not in ["cleric", "cleric apprentice"]
                    ]
    ...
    def update_button(self):
        ...
        if self.patrol_stage == "choose_cats":
            ...
            if any(
                (
                    cat.status in ["cleric", "cleric apprentice"]
    ...
    def update_selected_cat(self):
        ...
        if self.selected_cat is not None:
            ...
            if (
                self.selected_cat.status in ["cleric apprentice", "apprentice"]
                ...
                if (
                    ...
                    in ["cleric apprentice", "apprentice"]
